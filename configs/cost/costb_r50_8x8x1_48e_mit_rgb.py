_base_ = [
    '../_base_/models/i3d_r50_8f.py', '../_base_/schedules/sgd_48e.py',
    '../_base_/default_runtime.py'
]

# model settings
model = dict(
    backbone=dict(inflate_style='costb'), cls_head=dict(num_classes=339))
...
work_dir = './work_dirs/costb_r50_8x8x1_48e_mit_rgb/'
